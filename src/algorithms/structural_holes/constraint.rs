...
mod tests {
    ...
    fn test_constraint_2() {
        ...
        let result = constraint(&graph, None, true);
        println!("{:?}", result);
        assert_approx_eq!(result[&0], 0.19062348905638032);
        assert_approx_eq!(result[&1], 0.3409019831285561);
        assert_approx_eq!(result[&2], 0.25565383909645606);
        assert_approx_eq!(result[&3], 0.4122226156115593);
        ...
        assert_approx_eq!(result[&13], 0.3827486243156608);
        ...
        assert_approx_eq!(result[&27], 0.3222101463859707);
        assert_approx_eq!(result[&28], 0.39898274124464594);
        assert_approx_eq!(result[&29], 0.4389251973538791);
        assert_approx_eq!(result[&30], 0.3944911707240065);
